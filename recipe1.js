// ----------- functions for progress made in recipe ------------------
...
// update progress bar
function updateProgress(isCrossed) {
...
// cross off from voice command
function crossoffCommand(stepNum, clr, stepNumInt) {
    // not yet crossed off
    if (stepNum.style.color != clr) {
        stepNum.style.color = clr;
        stepNum.style.textDecoration = "line-through";
        ...
        return "step " + stepNumInt + "crossed off";

    } else {
        return "step " + stepNumInt + "already crossed off";
    }
}
...
function runSpeechRecognition() {
    ...
    var action = document.getElementById("action");
        ...
        recognition.onstart = function() {
            action.innerHTML = "<small> We're listening, please speak...</small>";
        };
        
        recognition.onspeechend = function() {
            action.innerHTML = "<small> We stopped listening, hope you are done...</small>";
            recognition.stop();
        }
...
function getMessage(str_request) {
    ...
    // steps done
    else if (str_request == "step one done" || str_request == "step 1 done") {
        var stepNum = document.getElementById("step 1");
        return crossoffCommand(stepNum, 'grey', 1);
    } else if (str_request == "step two done" || str_request == "step 2 done" || str_request == "step to done" || str_request == "step too done") {
        var stepNum = document.getElementById("step 2");
        return crossoffCommand(stepNum, 'grey', 2);
    } else if (str_request == "step three done" || str_request == "step 3 done") {
        var stepNum = document.getElementById("step 3");
        return crossoffCommand(stepNum, 'grey', 3);
    } else if (str_request == "step four done" || str_request == "step 4 done" || str_request == "step for done") {
        var stepNum = document.getElementById("step 4");
        return crossoffCommand(stepNum, 'grey', 4);
    } else if (str_request == "step five done" || str_request == "step 5 done") {
        var stepNum = document.getElementById("step 5");
        return crossoffCommand(stepNum, 'grey', 5);
    } else if (str_request == "step six done" || str_request == "step 6 done") {
        var stepNum = document.getElementById("step 6");
        return crossoffCommand(stepNum, 'grey', 6);
    } else if (str_request == "step seven done" || str_request == "step 7 done") {
        var stepNum = document.getElementById("step 7");
        return crossoffCommand(stepNum, 'grey', 7);
    } else if (str_request == "step eight done" || str_request == "step 8 done") {
        var stepNum = document.getElementById("step 8");
        return crossoffCommand(stepNum, 'grey', 8);
    } else if (str_request == "step nine done" || str_request == "step 9 done") {
        var stepNum = document.getElementById("step 9");
        return crossoffCommand(stepNum, 'grey', 9);
    } else if (str_request == "step ten done" || str_request == "step 10 done") {
        var stepNum = document.getElementById("step 10");
        return crossoffCommand(stepNum, 'grey', 10);
    } else if (str_request == "step eleven done" || str_request == "step 11 done") {
        var stepNum = document.getElementById("step 11");
        return crossoffCommand(stepNum, 'grey', 11);
    }
